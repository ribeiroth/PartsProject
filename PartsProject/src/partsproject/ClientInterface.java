...
public interface ClientInterface extends Remote{
    ...
    public Part getp (int id) throws RemoteException; //Busca uma peça por código no repositorio atual
    ...
    public void quit (String repositoryName) throws RemoteException; //Limpa todo repositorio
    
    public void getRepositoryName() throws RemoteException;
    
    public void searchPartById(int id) throws RemoteException; //Buscar peça em todos repositorios
